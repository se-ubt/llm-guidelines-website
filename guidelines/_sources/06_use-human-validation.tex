...
\begin{itemize}
    ...
    \item Employ established and widely accepted measurement methods and instruments. \comment{Should we also define the criteria for selecting human validators e.g., domain experts, end users, years of experience, familiarity with the task, or training protocols. }
\end{itemize}
...
\textbf{MAY}
\begin{itemize}
    \item Use multiple different measures (e.g., expert ratings, surveys, task performance) for human validation. \comment{Should there be training process e.g., pilot studies or calibration sessions to ensure consistent understanding of the evaluation criteria?}
\end{itemize}
