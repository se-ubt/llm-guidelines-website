...
% Mircea: This is quite a solid paragraph. The only observation is that the "hidden" dependencies feels a bit awkward. It sounds like we're accusing the researchers of hiding things? I guess not much would be lost if we removed that term? 
...
% Mircea: This is cool. And is much more advanced than I would be able to write :)
% The thing that I'm not sure about is: whoa re we advising here? Initially I thought 
% we are aiming at advice for software engineering researchers who are using LLMs. 
% But this advice is more for people who implement tools. Or? 
